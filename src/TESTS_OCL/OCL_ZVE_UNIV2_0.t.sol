...
import "../ZivoeOCLLockers/OCL_ZVE_UNIV2_0.sol";

contract OCL_ZVE_UNIV2_0Test is Utility {

    OCL_ZVE_UNIV2_0 OCL_CRV;
    ...
    function setUp() public {
        ...
        OCL_CRV = new OCL_ZVE_UNIV2_0(address(DAO), address(GBL));
