...
contract ZivoeSwapper is Ownable {
    ...
    function handle_validation_7c025200(bytes calldata data, address assetIn, address assetOut, uint256 amountIn) internal view {
        ...
        require(address(_b.srcToken) == assetIn, "ZivoeSwapper::handle_validation_7c025200() assetIn != data");
        require(address(_b.dstToken) == assetOut, "ZivoeSwapper::handle_validation_7c025200() assetOut != data");
        require(_b.amount == amountIn, "ZivoeSwapper::handle_validation_7c025200() amountIn != data");
        require(_b.dstReceiver == address(this), "ZivoeSwapper::handle_validation_7c025200() receiver != address(this)");
    }
    ...
    function handle_validation_e449022e(bytes calldata data, address assetIn, address assetOut, uint256 amountIn) internal view {
        ...
        require(_a == amountIn, "ZivoeSwapper::handle_validation_e449022e() amountIn != data");
    ...
    function handle_validation_2e95b6c8(bytes calldata data, address assetIn, address assetOut, uint256 amountIn) internal view {
        ...
        require(_a == assetIn, "ZivoeSwapper::handle_validation_2e95b6c8() assetIn != data");
        require(_b == amountIn, "ZivoeSwapper::handle_validation_2e95b6c8() amountIn != data");
        bool zeroForOne_0;
    ...
    function handle_validation_d0a3b665(bytes calldata data, address assetIn, address assetOut, uint256 amountIn) internal pure {
        ...
        require(address(_a.takerAsset) == assetIn, "ZivoeSwapper::handle_validation_d0a3b665() assetIn != data");
        require(address(_a.makerAsset) == assetOut, "ZivoeSwapper::handle_validation_d0a3b665() assetOut != data");
        require(_a.takingAmount == amountIn, "ZivoeSwapper::handle_validation_d0a3b665() amountIn != data._a");
    ...
    function handle_validation_b0431182(bytes calldata data, address assetIn, address assetOut, uint256 amountIn) internal pure {
        ...
        require(_a == assetIn, "ZivoeSwapper::handle_validation_b0431182() assetIn != data");
        require(_b == assetOut, "ZivoeSwapper::handle_validation_b0431182() assetOut != data");
